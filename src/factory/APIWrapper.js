...
/*
    ...
    function APIWrapper($http, $q, API_CONST, localStorageService, $mdDialog) {
        var basePath = API_CONST.BASE_PATH;
        var devicePath = API_CONST.DEVICE_BASE_PATH;
        var searchPath = API_CONST.SEARCH_BASE_PATH;
        var statusCodes = API_CONST.STATUS_CODES;
        var messageCodes = API_CONST.API_MESSAGES;
        var messageConsts = API_CONST.API_MSG_CONST;
        return {
